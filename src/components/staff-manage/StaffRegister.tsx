        ...
        <Box sx={{mt: 3}}>
            <Paper sx={{p: 3}}>
                <Box>
                    ...
                    <Grid xs={9} sx={{mt: 1, mb: 3}} container columnSpacing={6}>
                        <Grid item xs={6}>
                            <Box sx={{mt: 1, mb: 2}}>
                                ...
                                <TextField fullWidth variant="standard" placeholder="Tài khoản"
                        ...
                        <Grid item xs={6}>
                            <Box sx={{mt: 1, mb: 2}}>
                                ...
                                <TextField fullWidth variant="standard" placeholder="Mật khẩu" type="password"
                ...
                <Box sx={{mt: 3}}>
                    ...
                    <Grid xs={9} sx={{mt: 1, mb: 3}} container columnSpacing={6}>
                        <Grid item xs={6}>
                            ...
                            <TextField fullWidth variant="standard" placeholder="Họ"
                        ...
                        <Grid item xs={6}>
                            ...
                            <TextField fullWidth variant="standard" placeholder="Tên"
                ...
                <Box sx={{width: '70%', display: 'flex', justifyContent: 'center', mt: 6}}>
